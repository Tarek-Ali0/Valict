...
export function Hero({ dict }: HeroProps) {
  ...
  const heroContent = (
    <>
      ...
      <h1 className="text-3xl sm:text-4xl lg:text-5xl font-black leading-[1.15] lg:leading-[1.1] mb-0 text-valict-dark dark:text-white tracking-tight">
  ...
  return (
    <section ref={containerRef} className="relative h-[90dvh] lg:h-[115vh] transition-colors duration-300">
      
      {/* Sticky Container - تم تقليل المسافة العلوية pt لتقريب العناصر */}
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-start pt-8 lg:pt-12">
        ...
        <div className="lg:hidden relative z-20 flex flex-col items-center text-center px-4 w-full max-w-6xl mt-2">
          ...
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 font-medium mt-1 mb-1">
        ...
        {/* Laptop / Dashboard Image - تم تقليل الحجم وقاعدة الهامش العلوي ليقترب من العنوان */}
        <motion.div
          className="hidden lg:block relative z-30 w-full max-w-4xl lg:max-w-[920px] px-4 mt-2"
        ...
        {/* السطر والزرار تحت اللابتوب مباشرة وبدون أي قطع */}
        <div className="hidden lg:flex relative z-40 flex-col items-center text-center px-4 w-full max-w-4xl mt-1.5">
          <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-300 font-medium mb-1.5">
            {dict.hero.description || "Comprehensive managed IT and security solutions to keep your systems running smoothly."}
          </p>
          <Link
            href="#contact"
