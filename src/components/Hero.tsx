...
export function Hero({ dict }: HeroProps) {
  ...
  return (
    <section ref={containerRef} className="relative h-[90dvh] lg:h-[140vh] transition-colors duration-300">
      ...
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-start pt-20 lg:pt-24">
        ...
        <div className="lg:hidden relative z-20 flex flex-col items-center text-center px-4 w-full max-w-6xl">
          ...
          <Link
            href="#contact"
            className="font-sans btn-gradient text-white px-7 py-2.5 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-valict-cyan/25 mt-1"
          >
            {dict.hero.cta}
        ...
        <div className="hidden lg:flex relative z-40 flex-col items-center text-center px-4 w-full max-w-4xl mt-1">
          <Link
            href="#contact"
            className="font-sans btn-gradient text-white px-7 py-2 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-valict-cyan/25 hover:shadow-valict-cyan/40 transition-all duration-300"
          >
            {dict.hero.cta}
            <FaArrowRightLong className="h-4 w-4 rtl:rotate-180" />
          </Link>
