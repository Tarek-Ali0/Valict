...
export function Hero({ dict }: HeroProps) {
  ...
  const textY = useTransform(scrollYProgress, [0, 0.3], ["0vh", "-5vh"]);
  ...
  const heroContent = (
    <>
      <div className="inline-flex items-center gap-2 px-3 py-1 text-xs rounded-full bg-white/90 dark:bg-slate-900/90 backdrop-blur-md border border-slate-200/50 dark:border-slate-700/50 mb-2 shadow-sm">
      ...
      <h1 className="text-3xl sm:text-4xl lg:text-6xl font-black leading-[1.1] mb-1 text-valict-dark dark:text-white tracking-tight">
  ...
  return (
    <section ref={containerRef} className="relative h-[90dvh] lg:h-[130vh] transition-colors duration-300">
      
      {/* Sticky Container */}
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-start pt-14 lg:pt-16">
        ...
        <div className="lg:hidden relative z-20 flex flex-col items-center text-center px-4 w-full max-w-6xl">
          ...
          <Link
            href="#contact"
            className="font-sans btn-gradient text-white px-6 py-2 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-valict-cyan/20 mt-1"
          >
            {dict.hero.cta}
        ...
        <div className="hidden lg:flex relative z-40 flex-col items-center text-center px-4 w-full max-w-4xl mt-1">
          <Link
            href="#contact"
            className="font-sans btn-gradient text-white px-6 py-2 rounded-xl font-bold text-sm flex items-center gap-2 shadow-lg shadow-valict-cyan/20 hover:shadow-valict-cyan/40 transition-all duration-300"
          >
            {dict.hero.cta}
            <FaArrowRightLong className="h-4 w-4 rtl:rotate-180" />
          </Link>
