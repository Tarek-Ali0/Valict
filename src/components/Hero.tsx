...
export function Hero({ dict }: HeroProps) {
  ...
  return (
    <section ref={containerRef} className="relative min-h-[auto] lg:h-[120vh] transition-colors duration-300">
      
      {/* Sticky Container - في الموبايل هيمشي طبيعي من غير ارتفاع إضافي، وفي الديسكتوب هيفضل sticky */}
      <div className="relative lg:sticky top-0 lg:h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-start pt-20 sm:pt-24 lg:pt-24 pb-8 lg:pb-0">
        ...
        {/* 1. حاوية الموبايل والتابلت (تم ضبط الهوامش لتلغي الفراغ السفلي نهائياً) */}
        <div className="lg:hidden relative z-20 flex flex-col items-center text-center px-4 w-full max-w-6xl">
          {heroContent}
          <div className="w-full max-w-[340px] xs:max-w-xs sm:max-w-md my-2.5">
            <Image
