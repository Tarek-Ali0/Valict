...
export function Hero({ dict }: HeroProps) {
  ...
  const heroContent = (
    <>
     {/* البادج ببرواز رفيع جداً ومتدرج ملون ومتحرك */}
<div className="relative inline-flex p-[1px] rounded-full overflow-hidden mb-2.5 shadow-sm group">
  <span className="absolute inset-[-500%] bg-[conic-gradient(from_90deg_at_50%_50%,#22d3ee_0%,#3b82f6_25%,#a855f7_50%,#3b82f6_75%,#22d3ee_100%)] animate-border-rotate"></span>
