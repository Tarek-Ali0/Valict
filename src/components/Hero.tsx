...
export function Hero({ dict }: HeroProps) {
  ...
  return (
    <section ref={containerRef} className="relative h-[90dvh] lg:h-[120vh] transition-colors duration-300">
      
      {/* Sticky Container - مسافة أمان علوية ممتازة تبعد العناصر عن النافبار */}
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-start pt-20 sm:pt-24 lg:pt-24">
        ...
        <div className="lg:hidden relative z-20 flex flex-col items-center text-center px-4 w-full max-w-6xl mt-1">
          {heroContent}
          <div className="w-full max-w-[340px] xs:max-w-xs sm:max-w-md my-3">
            <Image
        ...
        {/* الزرار تحت اللابتوب للديسكتوب مباشرة بعد إزالة السطر */}
