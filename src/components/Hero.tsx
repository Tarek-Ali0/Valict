...
export function Hero({ dict }: HeroProps) {
  ...
  const heroContent = (
    <>
      ...
      {/* تكبير الخط مع ظبط الـ leading للغة العربية والإنجليزية لمنع التداخل */}
  ...
  return (
    <section ref={containerRef} className="relative h-[90dvh] lg:h-[130vh] transition-colors duration-300">
      ...
      <div className="sticky top-0 h-[100dvh] w-full overflow-hidden flex flex-col items-center justify-start pt-16 lg:pt-20">
        ...
        <motion.div
          className="hidden lg:block relative z-30 w-full max-w-4xl lg:max-w-[1000px] px-4 -mt-1"
        ...
        {/* زر الـ CTA (Get Started / ابدأ الآن) تحت اللابتوب مباشرة */}
