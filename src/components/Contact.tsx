          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-12 text-start">
            ...
            <div className="lg:w-1/3 flex flex-col gap-4 w-full">
              ...
              <div className="mt-4 flex flex-col items-start gap-2.5 w-full">
                ...
                >
                  <FaEnvelope className="w-5 h-5 text-valict-cyan shrink-0 order-last rtl:order-first" />
                  <span className="order-first rtl:order-last">{dict.contact.email}</span>
                </a>
                <a
                  href={`tel:${dict.contact.phone}`}
                  className="flex items-center gap-3 text-white/80 hover:text-white font-medium transition-colors group"
                >
                  <FaPhone className="w-5 h-5 text-valict-cyan shrink-0 order-last rtl:order-first" />
                  <span dir="ltr" className="order-first rtl:order-last">{dict.contact.phone}</span>
                </a>
              </div>
            </div>
          </div>
