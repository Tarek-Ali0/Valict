...
>
  <Image
    src="/valict-logo.png"
    alt="Valict Logo"
    width={1198}        // الأبعاد الحقيقية لملفك بالكامل
    height={351}       // النسبة الأصلية للحفاظ على الأبعاد بدون تمطيط
    unoptimized        // إيقاف المعالجة تماماً لضمان الجودة الأصلية 100%
    priority           // تحميل فوري
